...
sublitter_bijection
  ...
  ((π A).largest_sublitter (H.near_litter_image a.1.to_near_litter A (constrains.atom a A)).1)
...
begin
  ...
  split_ifs with ha,
  refl,
  rw h.near_litter_compatible a.1.to_near_litter A (constrains.atom a A) (constrains.atom a A),
end
