...
\begin{definition}
    ...
    % The appropriate \( \pi^0_s \) exists because of smallness of \( \dom \pi^0_a \).
\end{definition}
\begin{definition}
...
\begin{lemma}
    ...
    % TODO: We need an injectivity assumption on the hypothesis.
    % We can do without it, though, by just using the empty approximation if injectivity doesn't hold, although this will never occur in practice.
\end{lemma}
\begin{definition}
