...
\begin{definition}
  ...
  \item (Atoms:) For each litter $(L,A)$ not in $\dom \sigma$, then $\dom \sigma$ contains $<\kappa$-many atoms $(x,A)$ with $x \in L$; and dually for $\rge(\sigma)$.  On the other hand, for each litter $(L,A) \in \dom \sigma$ (say $M$ is the unique near-litter such that $(L,M,A) \in \sigma$), then either $\dom \sigma$ contains $<\kappa$-many atoms of $(L,A)$ and $\rge \sigma$ contains $<\kappa$-many atoms of $(M,A)$, or else $\dom \sigma$ contains all atoms of $(L,A)$ and all except $<\kappa$-many of them are mapped to atoms in $(M,A)$, and dually, $\rge \sigma$ contains all atoms of $(M,A)$ and maps them almost all to $(L,A)$; and dually for each litter $(L,A) \in \rge \sigma$.
...
\begin{proof}
  \uses{prop:allowable-partial-perm-chain-union,def:constrains-well-founded,lem:maximal-allowable-partial-perm-total,prop:total-allowable-partial-perm-actual}
...
\begin{proof}
  \uses{prop:allowable-partial-perm-action,prop:constrains-well-founded}
  ...
  TODO: incorporate the sketch of this proof.
\end{proof}
