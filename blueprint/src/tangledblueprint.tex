...
\begin{definition}
  ...
  \uses{def:concrete-phase-1-data,def:embedding-into-pretangles,def:typed-near-litter,def:typed-singleton,def:allowable-perm,def:tangle-action}
...
Throughout this section, fix some $\alpha \in \lambda + 1$, and assume coherent phase 1 data up to $\alpha$.
...
\begin{definition}
  ...
  \uses{def:coherent-phase-1-data,def:perm-exception,def:local-bijection,def:flexible}
...
\uses{def:freedom-of-action-statement,lem:strengthen-support}
