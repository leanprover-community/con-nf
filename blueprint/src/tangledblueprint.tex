...
\uses{lem:ainverse-stops, def:ainverse, def:code}
...
\uses{def:representative-code, def:ainverse, def:code}
...
\uses{def:allowable-perm, def:near-litter}
...
\begin{definition}[Local bijection]
...
\uses{def:derivative, def:perm-exception, def:strong-support}
