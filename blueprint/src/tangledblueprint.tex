...
\lean{con_nf.mul_action_support_condition}
\leanok
...
\uses{def:ainverse}
\lean{con_nf.A_map_relation_well_founded}
\leanok
...
\uses{def:code-equiv}
\lean{con_nf.code.is_representative}
% not putting \leanok until we have proven the required properties
...
\lean{con_nf.allowable_perm_coherence}
\leanok
...
\lean{con_nf.code.is_representative.smul}
\leanok
...
\lean{con_nf.semitangle.has_scalar}
\leanok
...
\begin{lemma}
  ...
  \uses{def:tangle}
  \lean{con_nf.new_tangle.mul_action}
  \leanok
