...
\label{def:support-of}
  \uses{def:support, def:derivative, def:support-condition-action}
...
\begin{definition}
  ...
  \uses{def:concrete-phase-1-data,def:embedding-into-pretangles,def:typed-near-litter,def:typed-singleton,def:allowable-perm,tangle-action}
