...
\begin{definition}
  ...
  \lean{con_nf.allowable_spec.perm_le}
  \leanok
...
\begin{proposition}
  ...
  \lean{con_nf.allowable_spec.allowable_Union}
  \leanok
...
\begin{proof}
  ...
  % not \leanok until we fix lower_flex_cond
...
\begin{lemma}
  ...
  \uses{def:allowable-partial-perm-order}
  \lean{con_nf.allowable_spec.total_of_is_max}
  \leanok
...
\begin{proposition}
  ...
  \lean{con_nf.allowable_spec.extends_to_allowable_of_total}
  \leanok
