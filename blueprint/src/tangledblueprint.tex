...
\uses {def:kappa}  \uses {def:mu}  \uses {near-litter}
...
\uses {def:alt-ext}  \uses {def: fmap}
...
\newpage
\subsection{Types are of size \texorpdfstring{$\mu$}{μ} (so the construction actually succeeds)}
