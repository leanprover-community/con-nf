...
\section{Preliminaries: phase 2 data}
...
\begin{definition}
  ...
  Note: to see these conditions are not unreasonable, note that each element has $<\mu$ many things that it must come after, and that the chains of these constraints are of depth at most 4: litters $<$ atoms $<$ other near-litters $<$ everything else.  (This should become the proof sketch for when we eventually construct these orderings below, as one of the last steps of the main recursion.)
...
\begin{definition}
  ...
  \uses{def:concrete-phase-1-data,def:embedding-into-pretangles,def:typed-near-litter,def:typed-singleton,def:allowable-perm}
...
\begin{definition}
  ...
  [Terminology: perhaps we should call this “phase 2 data at $\alpha$”?  That seems more consistent for the overall scheme, but “coherent phase 1 data up to $\alpha$” seems nicer and more transparent in itself.  Maybe we should reconsider the naming scheme.]
\end{definition}
