...
\begin{definition}
  ...
  \uses{def:coherent-phase-1-data,def:perm-exception,def:local-bijection,def:flexible,def:allowable-perm-atoms}
...
\begin{corollary}
  ...
  \uses{def:coherent-phase-1-data,def:freedom-of-action-statement}
